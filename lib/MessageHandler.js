class MessageHandler {
    constructor(bot, commandsFolder) {
        ...
        this.messageHandler = (message) => {
            if ((this.options.userRestricted && !this.options.userRestricted.includes(message.author.id)) || (message.author.bot && !this.options.allowedBots.includes(message.author.id)))
                return;
