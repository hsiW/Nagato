                                ...
                                if (this.commands.has(command.id))
                                    ...
                                    if (command.aliases)
                                        command.aliases.forEach(alias => {
                                            if (this.commandAliases.hasOwnProperty(alias))
                                                this.bot.log.warn(`${alias} has already been mapped to ${this.commandAliases[alias]} so it has been skipped.`)
                                            else
                                                this.commandAliases[alias] = command.id
                                        });
